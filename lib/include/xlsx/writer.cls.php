<?php
namespace PHPEMS\xlsx;
/**
 * Class writer
 * @package PHPEMS\xlsx
 * 本代码修改自php_xlsxwriter，使用其99%以上代码
 */
class writer{
    ...
    protected function writeCell(buffer &$file, $row_number, $column_number, $value, $num_format_type, $cell_style_idx)
    {

...
<div class="pages">
	...
	<div class="page-tabs">
		...
		<div class="page-content header footer">
			...
			<div class="list-box bg top" style="overflow:hidden;">
				<ol>
					<li class="unstyled col-4x text-center">
						<a href="index.php?content-phone" class="ajax rows">
							<img src="files/public/img/ico1.png" style="width:1rem;"/>
							<br />
							<span class="intro">新闻</span>
						</a>
					</li>
					<li class="unstyled col-4x text-center">
						<a href="index.php?course-phone-index-lists" class="ajax rows">
							<img src="files/public/img/ico2.png" style="width:1rem;"/>
							<br />
							<span class="intro">课程</span>
						</a>
					</li>
					<li class="unstyled col-4x text-center">
						<a href="index.php?exam-phone-basics" class="ajax rows">
							<img src="files/public/img/ico3.png" style="width:1rem;"/>
							<br />
							<span class="intro">考试</span>
						</a>
					</li>
					<li class="unstyled col-4x text-center">
						<a href="index.php?certificate-phone-certificate" class="ajax rows">
							<img src="files/public/img/ico4.png" style="width:1rem;"/>
							<br />
		...
		<div class="page-footer">
			...
			<div class="col-4x menu">
				<span class="fa fa-file-signature"></span><br />
				考试
			</div>
			<div class="col-4x menu">
		...
		<div class="page-content header footer">
			...
			<div class="list-box bg top">
				<ol>
					...
					<li class="unstyled">
						<a href="index.php?user-phone-certificate" class="ajax">
							<div class="rows info">
								我的证书
								<span class="pull-right"><em class="fa fa-chevron-right iconmenu"></em></span>
							</div>

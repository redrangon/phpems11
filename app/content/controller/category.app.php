...
class action extends app
{
	...
	private function index()
	{
		...
		$catchildren = M('category')->getCategoriesByArgs(array(array('AND',"catparent = :catparent",'catparent',$catid),array('AND',"catinmenu = '0'"),array('AND',"catapp = 'content'")));
		...
		$catbrother = M('category')->getCategoriesByArgs(array(array('AND',"catparent = :catparent",'catparent',$cat['catparent']),array('AND',"catinmenu = '0'"),array('AND',"catapp = 'content'")));

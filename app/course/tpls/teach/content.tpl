				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						...
						<span class="pull-right">
							{x2;if:$dir}
							<a class="btn btn-info" href="index.php?course-teach-contents&dirid={x2;$dir['coursedirid']}&courseid={x2;$course['csid']}&page={x2;$page}">上级目录</a>
							{x2;endif}
							<a class="btn btn-info ajax" href="index.php?course-teach-contents-struct&courseid={x2;$course['csid']}" target="modal-body" onclick="javascript:$('#modal').modal()">结构预览</a>

							<a class="btn btn-primary" href="index.php?course-teach-contents-addpage&dirid={x2;$dir['courseid']}&courseid={x2;$course['csid']}&page={x2;$page}">添加课件</a>
						</span>
					</h4>
					            	...
					            	<tr>
					                    ...
					                    <td class="actions">
					                    	<div class="btn-group">
												...
												<a class="btn" href="index.php?course-teach-contents&courseid={x2;v:content['coursecsid']}&dirid={x2;v:content['courseid']}{x2;$u}" title="目录内容">内容</a>
												{x2;endif}
												<a class="btn ajax" href="index.php?course-teach-contents-movedir&courseid={x2;v:content['coursecsid']}&source={x2;v:content['courseid']}&page={x2;$page}{x2;$u}" title="移动" target="modal-body2" onclick="javascript:$('#modal2').modal()">移动</a>
												<a class="btn" href="index.php?course-teach-contents-edit&courseid={x2;v:content['coursecsid']}&contentid={x2;v:content['courseid']}&page={x2;$page}{x2;$u}" title="修改">修改</a>
												<a class="btn confirm" href="index.php?course-teach-contents-del&courseid={x2;v:content['coursecsid']}&contentid={x2;v:content['courseid']}&page={x2;$page}{x2;$u}" title="删除">删除</a>
											</div>
					                    </td>
					                </tr>
					                {x2;endtree}

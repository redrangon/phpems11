					...
					<table class="table table-hover table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td class="actions">
									<div class="btn-group">
										<a class="btn" href="index.php?course-teach-course-members&courseid={x2;v:course['csid']}" title="用户"><em class="glyphicon glyphicon-user"></em></a>
										<a class="btn" href="index.php?course-teach-contents&courseid={x2;v:course['csid']}" title="课件"><em class="glyphicon glyphicon-list"></em></a>
									</div>
								</td>
							</tr>
							{x2;endtree}

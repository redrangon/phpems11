...
<li class="border unstyled">
    <a class="coursedir">&nbsp;{x2;$lessons[v:id]['coursetitle']}</a>
    {x2;else}
<li class="border unstyled" style="line-height: 0.3rem;vertical-align: middle">
    <a href="index.php?course-app-course&csid={x2;$course['csid']}&contentid={x2;v:id}" class="ajax {x2;if:v:id == $content['courseid']}courseactive{x2;endif}" data-target="pagination">

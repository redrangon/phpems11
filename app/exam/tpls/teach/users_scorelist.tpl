					...
					<form action="index.php?exam-teach-users-scorelist&basicid={x2;$basicid}" method="post">
						<table class="table form-inline">
					        <tr>
								...
								<td>
									<input class="form-control" name="search[username]" id="username" type="text" value="{x2;$search['username']}" size="10"/>
								</td>
								<td>
									批次：
								</td>
					        ...
					        <tr>
								...
								<td>
									<select name="search[examtype]" class="form-control">
										<option value="0">不限</option>
										<option value="1"{x2;if:$search['examtype'] == 1} selected{x2;endif}>模拟考试</option>
										<option value="2"{x2;if:$search['examtype'] == 2} selected{x2;endif}>正式考试</option>
									</select>
								</td>
								<td>
									排序：
								...
								<td>
									<select name="search[order]" class="form-control">
										...
										<option value="1"{x2;if:$search['order'] == 1} selected{x2;endif}>按名次排序</option>
									</select>
								</td>
								<td colspan="2">
									<button class="btn btn-primary" type="submit">提交</button>
									<a class="btn btn-primary" href="index.php?exam-teach-users-stats&basicid={x2;$basicid}{x2;$u}">统计</a>
									<a class="btn btn-primary ajax hide" href="index.php?exam-teach-users-outanswer&basicid={x2;$basicid}{x2;$u}">导出答案</a>
								</td>
					        </tr>
						</table>
						<div class="input">
			        ...
			        <table class="table table-hover table-bordered">
			            ...
			            <tbody>
					        ...
					        <tr{x2;if:v:exam['ehneedresit']} class="text-danger"{x2;endif}>
								...
								<td>
									{x2;if:v:exam['ehtype'] == 1}模拟考试{x2;else}正式考试{x2;endif}
								</td>
								<td>
								...
								<td>
									<a class="selfmodal btn" href="javascript:;" data-target="#modalinfo" url="index.php?exam-teach-users-resetinfo&ehid={x2;v:exam['ehid']}&useframe=1"><em class="glyphicon glyphicon-list-alt" title="评卷记录"></em></a>
								</td>
								<td>
									<a class="btn btn-primary" href="index.php?exam-teach-users-readpaper&ehid={x2;v:exam['ehid']}" target="_blank">阅卷</a>&nbsp;
									{x2;if:!v:exam['ehneedresit'] && v:exam['ehtype'] == 2}

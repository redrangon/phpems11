			        ...
			        <table class="table table-hover table-bordered">
			            ...
			            <tbody>
					        ...
					        <tr>
								...
								<td>
									<a class="selfmodal btn" href="javascript:;" data-target="#modal" url="index.php?exam-teach-users-resetinfo&ehid={x2;v:exam['ehid']}&useframe=1"><em class="glyphicon glyphicon-list-alt" title="评卷记录"></em></a>
								</td>
								<td>
									<div class="btn-group">

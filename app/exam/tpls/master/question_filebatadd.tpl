				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<form action="index.php?exam-master-questions-filebataddquestion" method="post" class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<img src="files/public/img/demo.png" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9 form-inline">
								...
								<span class="help-block">如果您的知识点ID和xlsx文件中的知识点ID不同，请在此填写您希望加入的知识点ID，否则请填写0</span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
						        ...
						        <div class="fineuploader" attr-type="files" attr-template="pe-template-uploadfile" attr-ftype="xlsx"></div>
								<span class="help-block">注意：导入文件必须为xlsx文件，可用excel保存为xlsx，为保证程序正常导入，每个xlsx文件请不要超过2M，否则可能导入失败</span>
							</div>
						</div>
						<div class="form-group">

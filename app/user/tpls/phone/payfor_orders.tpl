...
<div class="pages">
	...
	<div class="page-tabs">
		<div class="page-header">
			...
			<div class="col-8">我的订单</div>
			<div class="col-1"><span class="fa fa-menu"></span></div>
		</div>
		<div class="page-content header footer">
			<form class="list-box bg top" action="index.php?user-phone-payfor-orders" method="post" data-target="pagination">
				<div class="form-group">
					<div class="col-7" >
						<input type="search" value="{x2;$search['ordersn']}" class="form-control block" name="search[ordersn]" placeholder="请输入订单号">
					</div>
					<div class="col-3 tip">
			...
			<a href="index.php?user-phone-payfor-orderdetail&ordersn={x2;v:order['ordersn']}" class="ajax">

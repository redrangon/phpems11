			...
			<div class="content">
				...
				<div class="col-xs-9 nopadding" style="width: 80%">
					<div class="content-box padding">
						<h2 class="title">
							修改密码
							<a href="index.php?user-app-privatement" class="badge pull-right">个人资料</a>
						</h2>
						<ul class="list-unstyled list-img">
							<li class="border padding">
								<div class="desc">
									<form action="index.php?user-app-privatement-password" method="post" class="form-horizontal">
										<fieldset>
